...
def startscreen():
    ...
    while True: 
        slow_print("Frozen Palace: Non-AI Version")
        slow_print("START?")
...
def adventure_game():
    ...
    if (roomChoice == "Ahead" or "ahead"):
        ...
        if hasLight:
            slow_print("You light your way through the darkness.")
            slow_print("As you go through, you hear ")
        else:
            slow_print("You stumble around, searching for a wall to follow.")
