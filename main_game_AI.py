...
if (roomChoice == "Ahead"):
    ...
    if hasLight:
        ...
        - Candle
        - Lighter
        Player Actions: Walk forward with candle and lighter, searching for missing civilians.
        ...
        Equipment: 
        - Nothing
        Player Actions: Walk forward fumbling in the darkness, searching for missing civilians.
